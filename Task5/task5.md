...
Исходя из таблицы выше оптимальным выглядит подход Инвалидации на основе изменений, он отвечает требованиям консистентности данных и не потребует обширной разработки.с