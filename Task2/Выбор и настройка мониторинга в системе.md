...
Добавление мониторинга в систему позволит:
 - Получить бизнес-инсайты для определения паттернов использовании системы потребителями и приоритетов в развитии бизнеса через контроль количества запросов к API и нагрузки со стороны других подавцов ювелирных изделий
 - Уменьшить затраты на инфрастуктуру путём планирования и оптимизации утилизации ресурсов
